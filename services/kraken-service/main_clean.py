...
# Add parent app to path for shared utilities FIRST
...
async def lifespan(app: FastAPI):
        ...
        try:
            ...
            if kafka_consumer is not None:
                ...
                try:
                    ...
                    # start_consuming creates tasks and returns immediately, so we can call it directly
    ...
    logger.info("=" * 70)
        ...
        "rabbitmq_active": app.state.rabbitmq_consumer is not None,
        "kafka_active": app.state.kafka_consumer is not None
    }, "A")
